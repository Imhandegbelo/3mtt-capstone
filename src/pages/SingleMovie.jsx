...
export function SingleMovie() {
  ...
  return (
    <div className="flex max-w-[1440px] mx-auto text-base">
      ...
      {!movie ? (
        ...
        <div className="px-6 md:p-3 basis-11/12 md:basis-10/12 sm:mx-2 my-9 overflow-auto">
          ...
          <div className="mt-6 flex flex-col gap-6">
            <div>
              <h2 className="sm:text-md md:text-2xl text-rose-700">{movie?.title}</h2>
              ...
              <p className="inline-flex flex-wrap items-center gap-2">
                ...
                {movie?.genres.map((genre, index) => (
                  <span
                    key={index}
                    className="flex justify-between sm:ml-3 text-xs text-rose-700 lg:text-base leading-1"
                  >
                    {genre.name}
                  </span>
                ))}
