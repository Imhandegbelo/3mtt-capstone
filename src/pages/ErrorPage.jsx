...
export function ErrorPage() {
  return (
    <div className="flex bg-rose-50 w-full h-screen items-center">
      <div className="p-4 w-full sm:w-1/4 text-center text-rose-700 mx-auto rounded-2xl shadow-2xl">
        <h1 className="text-2xl">Error: 404</h1>
        <p className="py-4 text-sm">The requested resource could not be found</p>
